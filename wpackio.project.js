...
module.exports = {
	// Project Identity
	appName: 'udsWpDeprecationHelper', // Unique name of your project
	type: 'plugin', // Plugin or theme
	slug: 'uds-wp-depreciation-helper', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
	// Used to generate banners on top of compiled stuff
	bannerConfig: {
		name: 'udsWpDeprecationHelper',
		author: '',
		license: 'UNLICENSED',
		link: 'UNLICENSED',
		version: pkg.version,
		...
		// If this has length === 1, then single compiler
		{
			...
			entry: {
		     ...
		     // global namespace pollutions 😉
				admin: './admin/js/deprecation-helper-admin-react.js',
				public: './public/js/deprecation-helper-public-react.js',
			},
	...
	watch: './inc|includes|admin|public/**/*.php',

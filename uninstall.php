 ...
 * of control:
 *
 * - Check if the $_REQUEST['plugin'] content actually is uds-wp-depreciation-helper/uds-wp-depreciation-helper.php
...
function plugin_name_uninstall() {
	...
	if ( ! defined( 'WP_UNINSTALL_PLUGIN' )
		...
		|| 'uds-wp-depreciation-helper/uds-wp-depreciation-helper.php' !== $_REQUEST['plugin']
